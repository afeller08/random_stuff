...
class ShaInt(int):
    def __add__(self, other):
        res = super(ShaInt, self).__add__(other)
        return res % 32

    def __rshift__(self, other):
        asexp = 2 ** other
        left = (self % 2 ** asexp) << (32 - other)
        right = self // asexp
        return left | right
...
h0 = ShaInt(0x6a09e667)
h1 = ShaInt(0xbb67ae85)
h2 = ShaInt(0x3c6ef372)
h3 = ShaInt(0xa54ff53a)
h4 = ShaInt(0x510e527f)
h5 = ShaInt(0x9b05688c)
h6 = ShaInt(0x1f83d9ab)
h7 = ShaInt(0x5be0cd19)
